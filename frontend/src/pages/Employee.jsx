...
import EmployeeCard from "../components/common/EmployeeCard.jsx";
...
export default function Employee() {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      const res = await api.get(`/company/search?search=${search}`);
  ...
  useEffect(() => {
    const getEmployees = async () => {
      try {
        ...
        const res = await api.get("/company/getAllEmployees");
